...
public class FileSelectionActivity extends Activity {
	...
	private ArrayList<File> definitiveList = new ArrayList<File>();
	private ArrayList<String> definitiveStringList = new ArrayList<String>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        directoryView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				File directory = (File) directoryList.get(position);
				mainPath = directory;
				loadLists();
			}
		});
